...
/** Append-only version of the logically replaceable current-situation view. */
public record CurrentSituationVersion(
    UUID seriesId,
    UUID versionId,
    int version,
    MemoryScope scope,
    ...
    public CurrentSituationVersion {
        ...
        MemoryEvent.requireBoundedContent(content, 1_200, "current situation");
    }
}
